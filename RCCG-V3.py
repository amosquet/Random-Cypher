...
#redefining the numbers for the shift code output, shift of 3 letters is re-written as 73227 for output
	...
	print("Encoded Message: "+str_o[::-1]+"1111100"+hex)#printing the encoded message with the re-mapped shift code

if mode == "decode":
	x, y = input("Coded Message:") .split("1111100")#one line input for both the code and shift ammount
...
input("press enter to finish: ")
 ...
 #RCCG-V3 19/04/2021 Created by; Artus aka. AlmondMan
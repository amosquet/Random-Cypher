...
#redefining the numbers for the shift code output, shift of 3 letters is re-written as 73227 for output
	...
	print(str_o[::-1]+",-"+hex)#printing the encoded message with the re-mapped shift code
...
#making the shift ammount back into a redable for for the program
	...
	str_o = x.replace('5', '1')
	rep = str_o.replace('8', '0')

	fwrd = rep[::-1]#reversing the binary string in correct order ex; 1011 -> 1101
